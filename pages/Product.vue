        ...
        <section class="row m0 between-xs">
          ...
          <div class="col-xs-12 col-md-5 data">
            ...
            >
              ...
              <web-share
                :title="`${getCurrentProduct.name} оптом` | htmlDecode"
...
export default {
  ...
  metaInfo() {
    ...
    const singlePrice =
      ...
      parseInt(this.getCurrentProduct.attribute_10007);

    const pricePerItemDesc =
      singlePrice > 0 ? `Цена ${singlePrice} рублей за шт.` : ``;
    ...
    return {
      title: this.getCurrentProduct.meta_title
        ? this.getCurrentProduct.meta_title
        : htmlDecode(`${this.getCurrentProduct.name} оптом`),
