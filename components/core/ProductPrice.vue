...
<div class="mb40 price serif">
    ...
    <div class="h3 cl-secondary" v-if="initialPrice.special && price.default && price.original">
        ...
        <span class="price-original h3">{{ price.original | price(storeView) }}</span>
    </div>
    <div class="h2 cl-mine-shaft weight-700" v-if="!initialPrice.special && price.default">
...
export default {
    ...
    computed: {
        ...
        price() {
            ...
            const complectQty = parseInt(this.product.attribute_10007)
            ...
            return {
                ...
                single: defaultPrice / complectQty
            }
        },
        initialPrice() {
            return {
